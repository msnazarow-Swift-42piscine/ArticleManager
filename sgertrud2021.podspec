Pod::Spec.new do |s|
  ...
  So the main goal of the pod is to make your articles persistes and incapusale work with Coredata
                       DESC
  s.homepage         = 'https://github.com/msnazarow-Swift-42piscine/ArticleManager'
  s.module_name   = 'ArticleManager'
  s.source           = { :git => 'https://github.com/msnazarow-Swift-42piscine/ArticleManager.git', :tag => s.version.to_s }
  s.swift_version = '5.0'
